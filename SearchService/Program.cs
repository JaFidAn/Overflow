...
if (string.IsNullOrWhiteSpace(typesenseUri))
    throw new InvalidOperationException($"The typesense URI is {typesenseUri} not found in config");

var typesenseApiKey = builder.Configuration["typesense-api-key"];
if (string.IsNullOrWhiteSpace(typesenseApiKey))
    throw new InvalidOperationException($"The typesense API key is {typesenseApiKey} not found in config");
